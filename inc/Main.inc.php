...
require_once('inc/Lib/Configuration/Entry.inc.php');
require_once('inc/Lib/Configuration/Section.inc.php');
require_once('inc/Lib/Configuration/Configuration.inc.php');
...
class Main {
    ...
    public function init() {
        ...
        //TPL init
        $tpl->assign('loggedin', $user->isLoggedIn());
    ...
    public static function loadFiles($class_name) {
        ...
        if (substr($class_name, 0, 4) == 'FLS\\') {
            ...
            $load = 'inc/' . $class_name . '.inc.php';
        } else if (file_exists('inc/' . $class_name . '.inc.php')) {
            $load = 'inc/' . $class_name . '.inc.php';
    ...
    public static function checkContentFileExist($class_name) {
        ...
        if (strstr($class_name, 'BoxContent')) {
            ...
            $status = is_file($class_name . '.inc.php');
        }
        return $status;
    }
